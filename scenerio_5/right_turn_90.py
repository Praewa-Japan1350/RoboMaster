...
def main():
    ...
    print("Recording scenario 5: straight 3s -> right 90° -> stop")
    time.sleep(1)
    ...
    try:
        ...
        print('Right turn failed:', e)

    time.sleep(0.5)

    print("Scenario 5 finished. Saving files...")
    ...
    print("Saved: ACC.csv, GYRO.csv, Distance.csv in scenerio_5")
